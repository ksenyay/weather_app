...
document.querySelector("#backgrounds").addEventListener("change", setBackground);
function setBackground() {
  var select = document.querySelector("#backgrounds");
  var appBackground = document.querySelector(".background");
  var currentBackground = select.value;
  console.log(currentBackground);
  appBackground.style.backgroundImage = "url(\"img/".concat(currentBackground, ".jpg\")");
}